...
rootdir <- "E:/Training of Map Change 16-19 May 2017/" ##### Have to change the value here
setwd(rootdir)

#### Name of the directory where your Landsat data is
lsat_dir <- paste0(rootdir,"time_series/")  ##### Add time_series for getting data to that folder
...
dest_dir <- paste0(rootdir,"clip_time_series_test/")  ##### Have to change the value here
...
###### The export image will be in a 2 (height) x 3 (width) grid box
dim_v_grid <- 3
dim_h_grid <- 2

for(the_id in listodo[5]){ 
